const Row = () => {
    return (
        <tr>
            <th scope="row">Pet the cat</th>
            <td>2021-10-01</td>
            <td>Random Thought</td>
            <td>Find a cat, catch it, pet it</td>
            <td></td>
            <td>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="icon-archive onIcon mx-1 bi bi-save green" viewBox="0 0 16 16">
