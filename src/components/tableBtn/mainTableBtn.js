...
const MainTableBtn = ({id}) => {
    const dispatch = useDispatch();

    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="icon-edit onIcon mx-1 bi bi-pencil-square" viewBox="0 0 16 16">
